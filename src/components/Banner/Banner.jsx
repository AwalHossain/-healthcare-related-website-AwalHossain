...
https://727512.smushcdn.com/1881491/wp-content/uploads/2016/11/image-3.jpg?lossy=1&strip=1&webp=1" class="d-block w-100" alt="..." />
      <div class="carousel-caption d-block d-md-block">
        <h5 className="animated-left" style={{animationDelay:"1s"}}>First slide label</h5>
        <p className="animated-right" style={{animationDelay:"2s"}}>Some representative placeholder content for the first slide.</p>
        <p className="animated-right" style={{animationDelay:"2s"}}><a href="/">More Info</a></p>
      </div>
    </div>
    <div class="carousel-item ">
      ...
      <div class="carousel-caption second-slide d-block d-md-block">
        <h5 className="animated-left" style={{animationDelay:"1s"}}>Second slide label</h5>
        <p className="animated-right" style={{animationDelay:"2s"}}>Some representative placeholder content for the second slide.</p>
        <p className="animated-right" style={{animationDelay:"2s"}}><a href="/">More Info</a></p>
      </div>
    </div>
    <div class="carousel-item">
      ...
      <div class="carousel-caption d-block d-md-block">
        <h5 className="animated-left" style={{animationDelay:"1s"}}>Third slide label</h5>
        <p className="animated fadeInLeft" style={{animationDelay:"2s"}}>Some representative placeholder content for the third slide.</p>
        <p className="animated zoomIn" style={{animationDelay:"2s"}}><a href="/">More Info</a></p>
      </div>
    </div>
  </div>
